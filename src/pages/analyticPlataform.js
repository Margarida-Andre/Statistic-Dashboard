...
import { faHome, faChartLine, faCog, faUser, faBell, faOutdent, faSearch } from "@fortawesome/free-solid-svg-icons";
        ...
        <section className={styles.section}>
            ...
            <div className={styles.div2}>
                <article className={styles.article1}>
                    ...
                    <h1 className={styles.h1hello}>Hello, Alisha Chef</h1>
                        ...
                        <Image src={Emoji} alt="" className={styles.image}  
                        width={30}
                        height={30}   
                        /></div>
                    ...
                    <div className={styles.containerIcon}><FontAwesomeIcon icon={faBell} className={styles.icon}/></div>
            ...
            <h1 className={styles.h1Activity}>Activicty Statistics</h1>
                <ul className={styles.ul1}>
                    <p className={styles.textDark}>Development by points: <span className={styles.textWhite}>3 directions used</span></p>
                  <Grafico2/>
                </ul>
                <ul className={styles.ul2}>
                <p className={styles.textDark}>Tested activity: <span className={styles.textWhite}>2 directions used</span></p>
                <Grafico4 /> 
                </ul>
                <ul className={styles.ul3}>
                <p className={styles.textDark}>Last week's progress: <span className={styles.textWhite}>4 directions used</span></p>
                <Grafico3/>  
                <button type="submit" className={styles.btn}>View more info</button>
                </ul>
            </div>
